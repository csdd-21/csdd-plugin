...
mongoose.connect("mongodb://127.0.0.1:27017/csdd-plugin", { useUnifiedTopology: true, useNewUrlParser: true });
...
const Plugin = mongoose.model('Plugin', new mongoose.Schema({
  ...
  tag: { type: Object, require: true },
  desc: { type: String, require: true },
  author: { type: String, require: true },
  auth: { type: String, require: true },
  publish: { type: Number, require: true },
}))
