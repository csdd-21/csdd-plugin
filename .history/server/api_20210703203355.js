...
function a(req) {
    ...
    return new Promise(resolve => {
        fs.renameSync(path.join(process.cwd(), "/" + req.body.imgPath), path.join(process.cwd(), '../public/' + targetPath), (err) => {
            if (err) throw err;
            resolve('finish')
        })
        resolve('finish')
...
fs.unlinkSync('C:/Users/86138/Desktop/csdd-plugin/public/imgs/呀呀呀呀呀呀晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕晕.png'); 
