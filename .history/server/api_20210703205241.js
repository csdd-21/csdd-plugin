...
app.post("/submit", function (req, res, next) {
    ...
    let readStream = fs.createReadStream('C:/Users/86138/Desktop/csdd-plugin/public/a.txt');
    let len = 0;
    ...
    let writeStream = fs.createWriteStream('C:/Users/86138/Desktop/csdd-plugin/public/imgs/a.txt');
    readStream.pipe(writeStream);
    fs.unlinkSync('C:/Users/86138/Desktop/csdd-plugin/public/imgs/222222222222222222222.png');
    // fs.renameSync(path.join(process.cwd(), "/" + req.body.imgPath), path.join(process.cwd(), '../public/' + targetPath))
