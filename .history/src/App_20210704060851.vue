<template>
  <div id="app">
    ...
    <el-dialog title="提示" v-model="show.dialog" width="30%" :before-close="click_close_dialog" center>
      <div>
        <el-button @click="show.admin = true" v-if="!show.admin">管理员</el-button>
        <el-button @click="click_visitor" v-if="!show.admin">访客</el-button>
      </div>
      <el-form v-if="show.admin" :model="form" :rules="rules" ref="form" label-width="60px">
