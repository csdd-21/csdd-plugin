<template>
  <div id="app">
    ...
    <el-dialog title="提示" v-model="show.dialog" width="30%" :before-close="click_close_dialog">
      ...
      <el-form v-if="show.admin" :model="form" :rules="rules" ref="form" label-width="100px">
      ...
      <i class='desc'><i class='iconfont icon-xinghao'></i> 管理员可以直接发布文章，访客新增的文章需要在审核完后才会发布哦~</i>
    </el-dialog>
  </div>
</template>
