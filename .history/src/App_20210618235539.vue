<template>
  <div id="app">
    <el-container id="content">
      ...
      <el-button class="add" id="add" @click="click_add" v-show="!show.new && !show.about"><i class="iconfont icon-fabu"></i></el-button>
      <el-button class="add" id="add" @click="click_back" v-show="show.new && !show.about"><i class="iconfont icon-fanhui"></i></el-button>
