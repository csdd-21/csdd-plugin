<template>
  <div id="app">
    <el-container id="content">
      ...
      <el-button class="add" id="add" @click="click_add" v-show="!showAdd"><i class="iconfont icon-fabu"></i></el-button>
      <el-button class="add" id="add" @click="click_back" v-show="showAdd"><i class="iconfont icon-fanhui"></i></el-button>
      <router-view style="min-height: 80vh; padding-bottom: 80px" :key="routerKey" />
      <el-footer v-show="!showAdd"> Made with csdd - <a href="https://github.com/csdd-21?tab=repositories" target="_blank"> Click here to enter Github</a> <i class="iconfont icon-github"></i></el-footer>
    </el-container>
  </div>
</template>
