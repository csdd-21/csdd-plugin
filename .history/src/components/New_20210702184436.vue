  ...
  <div class="new">
    <el-form :model="form" ref="form" :rules="rules" class="demo-form-inline">
      ...
      <el-form-item label="网址" prop="url" label-width="80px">
        ...
        <el-button @click="click_submit" type="primary"><a :href="form.url" target="__blank">测试</a></el-button>
      </el-form-item>
...
export default {
  ...
  mounted() {
   ...
   this.form.auth = this.$route.params.auth
   this.SET_SHOW_PARAMS([{ key: "fabuIcon", value: false },{ key: "backIcon", value: true },{ key: "footer", value: false }]);
  },
};
</script>
