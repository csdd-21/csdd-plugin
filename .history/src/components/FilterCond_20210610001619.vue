<template>
  <div class="filterCond">
    <div class='search'>
      <el-input v-model='checked.title' @click='handleSearch' placeholder='Type title or select tag below to search...'> </el-input>
    ...
    <el-checkbox-group v-model="checked.tags">
      <el-checkbox-button v-for="i in tags" :label="i._id" :key="i._id">{{ i._id }}</el-checkbox-button>
    </el-checkbox-group>
  </div>
</template>
