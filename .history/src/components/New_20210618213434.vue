...
export default {
  ...
  data() {
    const isValidate = (rule, value, callback) => {
      console.log("t----1", rule, "t----2", value, callback);
    ...
    return {
      ...
      rules: {
        author: [{ validator: isValidate, trigger: ["blur", "change"] }],
        // imgPath:[{ validator: isValidate, trigger: ["blur", "change"] }],
        title: [{ validator: isValidate, trigger: ["blur", "change"] }],
        tag: [{ validator: isValidate, trigger: ["blur", "change"] }],
        desc: [{ validator: isValidate, trigger: ["blur", "change"] }],
      },
    };
  },
  watch: {},
