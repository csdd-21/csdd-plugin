  ...
  <div class="new">
    <el-form :model="form" ref="form" :rules="rules" class="demo-form-inline">
      <el-form-item label="图片" prop="imgPath" label-width="80px">
        <el-upload action="/api/upload" :before-upload="handle_before" :on-change="handle_change" :on-remove="handle_remove" :on-success="handle_success" v-model="form.icon" list-type="picture-card">
