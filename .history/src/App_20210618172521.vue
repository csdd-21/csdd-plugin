<template>
  <div id="app">
    <el-container id="content">
      ...
      <el-button class="add" @click='click_add'><i class='iconfont icon-fabu'></i></el-button>
...
export default {
  ...
  watch: {
    ...
    tab(val) {
      if (val =='about'){
        console.log('gggg',document.getElementsByClassName('add'));
        
        document.getElementsByClassName('add').hidden='true'
      }
