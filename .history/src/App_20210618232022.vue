<template>
  <div id="app">
    <el-container id="content">
      ...
      <!-- <el-button class="add" id="add" @click="click_add"><i class="iconfont icon-fabu"></i></el-button> -->
      <el-button class="add" id="add" @click="click_add"><i class="iconfont icon-fanhui"></i></el-button>
