<template>
  <div id="app">
    <el-container id="content">
      ...
      <div>
        <el-button class="add" id="add" @click="click_add" v-show="!showNew"><i class="iconfont icon-fabu"></i></el-button>
        <el-button class="add" id="add" @click="click_back" v-show="showNew"><i class="iconfont icon-fanhui"></i></el-button>
      </div>
