<template>
  <div id="app">
    <el-container id="content">
      ...
      <el-footer v-if='showFooter'> Made with csdd - <a href="https://github.com/csdd-21?tab=repositories" target="_blank"> Click here to enter Github</a> <i class="iconfont icon-github"></i></el-footer>
    </el-container>
