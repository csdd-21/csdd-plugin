<template>
  <div class="home">
    ...
    <div class="contentWrapper" v-loading="loading" element-loading-text="Loading..." element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)" style="color: red">
