<template>
  <div class="home">
    ...
    <div class="contentWrapper">
      <span :style="datas.length == 0 ? empty.show : empty.hide">
        <i class="iconfont icon-empty" style='display:block;font-size:20px;'></i>
        {{ empty.info }}</span
      >
    ...
    <div class="page" :key="page.skip" :style="datas.length == 0 ? empty.hide : empty.show">
