<template>
  <div class="home">
    ...
    <div style='color:red;' class="page" :key="page.skip" :style="datas.length == 0 ? empty.hide : ''">
      <el-pagination style='color:red;'  layout="prev, next, jumper" :total="total" :current-page="page.skip" :page-size="page.limit" @current-change="handleCurrentPage" background> </el-pagination>
