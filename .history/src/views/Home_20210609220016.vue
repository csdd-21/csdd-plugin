<template>
  <div class="home">
    <FilterCond class="filter" :tags='$store.state.tags' @handleFilter='handleFilter'> </FilterCond>
    <!-- <el-button @click='SET_REQ_DEFAULT'>重置</el-button> -->
